                    ...
                    <form role="form" class="" method="POST" action="{{ route('email-template.update',$template->id) }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group pb-1">
                                ...
                                <div class="pb-1">
                                    <textarea class="textarea w-100" name="custom_content" placeholder="{{ __('lang.place_of_content') }}" required>{{ clean($template->custom_content ?? $template->default_content) }}</textarea>
                                </div>
                            </div>

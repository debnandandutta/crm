        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" class="" method="POST" action="{{ route('kb.store') }}" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="title">Upload File</label><br>
                                <div class="form-check-inline">
                                    <label class="file"><span class="file">File</span>

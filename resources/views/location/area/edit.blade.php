...
@section('main-section')
    <div class="container-fluid">
        @if($permission->manageStaff() == 1)
            <h4 class="page-title">{{ __('lang.edit_area') }}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" class="" method="POST" action="{{route('update-area')}}">
                            {!! csrf_field() !!}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="name" type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $area->areaName}}" placeholder="{{ __('lang.enter_name') }}" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="region" class="form-control" name="region" required>
                                                ...
                                                @foreach ($regions as $region)
                                                    <option value="{{ $region->id }}" {{ $area->regionId === $region->id ? 'selected' : '' }}>{{ $region->title }}</option>
                                                @endforeach
                                            </select>

...
@if($ticket->preferrence = 1)
@section('title', __('lang.edit_new_case'))
    @else
        @section('title', __('lang.edit_new_ticket'))
        @endif
@section('style')
    <style>
...
@section('main-section')
    <div class="container-fluid">
        @if($permission->manageStaff() == 1)
            ...
            <h4 class="page-title">{{ __('lang.edit_new_case') }}
                <a href="{{ route('dashboard') }}" class="btn btn-primary pull-right">{{ __('lang.back') }}</a>
            </h4>
        @else
            <h4 class="page-title">{{ __('lang.edit_new_ticket') }}
                <a href="{{ route('dashboard') }}" class="btn btn-primary pull-right">{{ __('lang.back') }}</a>
            </h4>
        @endif
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                        <form role="form" autocomplete="off" class="form form-horizontal" method="POST" action="{{route('enquiry.update')}}">
                        {!! csrf_field() !!}
                        <input type="hidden" class="form-control" name="enquiry_id" id="enquiry_id" value="{{$ticket->enquiry_id}}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-primary" autocomplete="off" type="text" placeholder="Enter Name" id="callerName" required value="{{$ticket->title}}" name="callerName">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="callerinput2">Shop Name</label>
                                                        <input class="form-control border-primary" autocomplete="off" type="text" name="shopName" id="shopName" value="{{$ticket->shop}}" placeholder="Enter Shop Name" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-primary" autocomplete="off" type="text" placeholder="Enter Mobile Number" value="{{$ticket->mobileOne}}" required name="mobileOne" id="mobileOne">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="callerinput4">Mobile 2</label>
                                                        <input class="form-control border-primary" autocomplete="off" type="text"  placeholder="Enter Enter Mobile Number" value="{{$ticket->mobileTwo}}" name="mobileTwo" id="mobileTwo">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-primary" autocomplete="off" type="text" placeholder="Enter Mobile Number" required value="{{$ticket->address}}" name="address" id="address">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="region" name="region" required class="form-control">
                                                            ...
                                                            @foreach ($regions as $region)
                                                                <option data-region="{{ $region->title }}" value="{{ $region->id }}"  {{ ($ticket->region_id === $region->id || $region->id==6) ? 'selected' : '' }}>{{ $region->title }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="area" name="area"  class="form-control">
                                                            ...
                                                            @foreach ($areas as $area)
                                                                <option value="{{ $area->id }}" {{ $ticket->area === $area->id ? 'selected' : '' }}>{{ $area->areaName }}</option>
                                                            @endforeach
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="territory" name="territory" class="form-control">
                                                            ...
                                                            @foreach ($territories as $territory)
                                                                <option value="{{ $territory->id }}" {{ $ticket->territory === $territory->id ? 'selected' : '' }}>{{ $territory->territoryName }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="town" name="town" class="form-control">
                                                            ...
                                                            @foreach ($towns as $town)
                                                                <option value="{{ $town->id }}" {{ $ticket->town === $town->id ? 'selected' : '' }}>{{ $territory->townName }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="position-relative has-icon-left">
                                                        <input type="date" class="form-control" name="expiry" id="expiry" value="{{$ticket->expiry}}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group" id="tm1">
                                                        <input type="hidden" class="form-control" name="tm" id="tm" value="{{$ticket->tm}}">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="complain2" class="required">Caller Type</label>
                                                        <select id="callerType" required name="callerType" class="form-control callType">
                                                            <option value="Consumer"  {{ $ticket->callerType === 'Consumer' ? 'selected' : '' }}>Consumer</option>
                                                            <option value="Retailer"  {{ $ticket->callerType === 'Retailer' ? 'selected' : '' }}>Retailer</option>
                                                          </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="complain1" > Description</label>
                                                        <textarea  class="kb-desc textarea my-editor" rows="5" class="form-control" name="description" id="description" >{{ clean($ticket->description) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="callType" required name="callType" class="form-control callType">
                                                            ...
                                                            @foreach ($callType as $call)
                                                                <option data-call="{{ $call->name }}" value="{{ $call->id }}" {{ $call->selected === 1 || $ticket->callType== $call->id ? 'selected' : '' }}>{{ $call->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="store" name="store" class="form-control">
                                                            ...
                                                            <option value="pollydut"  {{ $ticket->storeType === 'pollydut' ? 'selected' : '' }}>Pollydut</option>
                                                            <option value="retailer"  {{ $ticket->storeType === 'retailer' ? 'selected' : '' }}>Retailer</option>
                                                            <option value="wholesale"  {{ $ticket->storeType === 'wholesale' ? 'selected' : '' }}>Whole Sale</option>
                                                            <option value="productstore"  {{ $ticket->storeType === 'productstore' ? 'selected' : '' }}>Product Store</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control border-primary" type="text" placeholder="Enter Name" name="dsrName" id="dsrName"  value="{{$ticket->dsr_name}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="department_id" required name="department_id" class="form-control">
                                                            ...
                                                            @foreach ($brands as $brand)
                                                                <option value="{{ $brand->id }}" data-brand="{{ $brand->title }}" {{ $ticket->department_id === $brand->id ? 'selected' : '' }}>{{ $brand->title }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="position-relative has-icon-left">
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio"  id="customRadioInline1" name="preferrence" value="0"  class="custom-control-input">
            ...
            <div class="modal" id="my_modal">
                <div class="modal-dialog modal-dialog-centered">
                    <form role="form" class="form form-horizontal" method="POST" action="{{route('enquiry.update')}}">
                        {!! csrf_field() !!}

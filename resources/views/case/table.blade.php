...
@section('js')
    ...
    <script src="{{ asset('assets/js/enqMain.js') }}"></script>



    <script type="text/javascript" src="{{ asset('assets/') }}/JSZip-2.5.0/jszip.min.js"></script>
    <script type="text/javascript" src="{{ asset('assets/') }}/pdfmake-0.1.36/pdfmake.min.js"></script>
    <script type="text/javascript" src="{{ asset('assets/') }}/pdfmake-0.1.36/vfs_fonts.js"></script>
    <script type="text/javascript" src="{{ asset('assets/') }}/Buttons-1.6.5/js/dataTables.buttons.min.js"></script>
    <script type="text/javascript" src="{{ asset('assets/') }}/Buttons-1.6.5/js/buttons.colVis.min.js"></script>
    <script type="text/javascript" src="{{ asset('assets/') }}/Buttons-1.6.5/js/buttons.flash.min.js"></script>
    <script type="text/javascript" src="{{ asset('assets/') }}/Buttons-1.6.5/js/buttons.html5.min.js"></script>
    <script type="text/javascript" src="{{ asset('assets/') }}/Buttons-1.6.5/js/buttons.print.min.js"></script>

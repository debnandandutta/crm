...
@section('title', __('lang.add_retailer'))

@section('main-section')
    <div class="container-fluid">
        @if($permission->manageStaff() == 1)
            <h4 class="page-title">{{ __('lang.add_retailer') }}
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" class="" method="POST" action="{{route('save-retailer')}}">
                            {!! csrf_field() !!}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="name">{{ __('lang.retailer') }}</label>

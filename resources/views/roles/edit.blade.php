                    ...
                    <form role="form" class="mx-auto w-50" method="POST" action="{{ route('role-update.update',$data->id) }}">
                        ...
                        <div class="card-body">
                            ...
                            <div class="box-header my-2">
                                <h6 class="box-title">{{ __('lang.item') }}</h6>
                            </div>
                            <div class="form-group minimal">
                                <input type="checkbox"  id="role-10" value="can_manage_item"  @if($data->permissions){{ in_array("can_manage_item",$data->permissions) ? "checked" : "checked" }}@endif name="permissions[]">
                                <label for="role-10" class="font-weight-normal">{{ __('lang.can_manage_item') }}</label>
                                <span></span>
                            </div>
                        </div>
                        <!-- /.card-body -->

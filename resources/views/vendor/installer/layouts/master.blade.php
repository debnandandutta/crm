...
<html>
    <head>
        ...
        <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif {{ trans('Helpy Installer') }}</title>
        ...
        <link href="{{ asset($publicPath.'/installer/css/style.min.css') }}" rel="stylesheet"/>
        @yield('style')
        <script>
    ...
    <body>
        <div class="master" style="background-image: linear-gradient(to right, #2F80ED, #56CCF2) !important;">
            <div class="box">
                <div class="header" style="background-image: linear-gradient(to right, #2F80ED, #56CCF2) !important;">
                ...
                <ul class="step">
                    ...
                    <li class="step__divider"></li>
                    <li class="step__item {{ isActive('LaravelInstaller::userMenu') }}">
                        @if(Request::is('install/user') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                            <a href="{{ route('LaravelInstaller::userMenu') }}">
                    ...
                    <li class="step__item {{ isActive('LaravelInstaller::permissions') }}">
                        @if(Request::is('install/permissions') || Request::is('install/user') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
                    ...
                    <li class="step__item {{ isActive('LaravelInstaller::requirements') }}">
                        @if(Request::is('install') || Request::is('install/requirements')  || Request::is('install/permissions') || Request::is('install/user') || Request::is('install/environment') || Request::is('install/environment/wizard') || Request::is('install/environment/classic') )
